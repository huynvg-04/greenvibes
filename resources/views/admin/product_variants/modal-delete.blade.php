    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow rounded-4 overflow-hidden">
            <div class="modal-body text-center p-4">
                ...
                <h5 class="mb-2 fw-bold text-body">Xóa phân loại này?</h5>
                <p class="text-muted small mb-4">
                    Hành động này không thể hoàn tác.<br>
                    Phân loại <strong id="modalVariantName" class="text-body">...</strong> sẽ bị xóa vĩnh viễn.
                </p>
                ...
                <form id="deleteForm" method="POST" action="" class="d-grid gap-2">
                    ...
                    <button type="button" class="btn btn-light text-muted rounded-pill fw-bold py-2" data-bs-dismiss="modal">Hủy bỏ</button>
                </form>
            </div>
        </div>
    </div>
