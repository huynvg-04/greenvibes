...
<body>
    <div class="error-container">
        ...
        <div class="error-code anim-item delay-2">404</div>

        <div class="error-message anim-item delay-3">
            <h2>Ối! Lạc đường rồi...</h2>
            <p>Trang bạn đang tìm kiếm không tồn tại hoặc đã bị xóa.<br>Đừng lo, hít thở sâu và quay về nhà nhé!</p>
        </div>

        <div class="btn-container anim-item delay-4">
            <a href="{{ $homeUrl ?? url('/') }}" class="btn btn-home">
                <i class='bx bxs-dashboard'></i>{{ $btnText ?? 'Về Trang chủ' }}
            </a>
